document.querySelector('#btnsave').addEventListener('click', saveSalida);
drawSalidas();
    ...
    var sClient = document.querySelector('#cliente').value,
     ...
     sTotal = sCant*sPrice;
     addSalidaToSystem(sClient, sDate, sType, sCod, sProduct, sCant, sPrice, sTotal);
     drawSalidas();
    }



function drawSalidas(){
    var list = getSalidas(),
    tbody = document.querySelector('#tablasalidas tbody');
